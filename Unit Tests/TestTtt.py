...
def test_has_won():
    ...
    ttt.board = np.array([1, 2, Qttt.ttt.EMPTY_BLOCK_VAL,
                          3, 4, Qttt.ttt.EMPTY_BLOCK_VAL,
                          7, 6, Qttt.ttt.EMPTY_BLOCK_VAL])
    assert (ttt.has_won() == (True, "EVEN_ODD_WIN"))
    ttt.board = np.array([3, 2, 9,
                          4, 1, 8,
                          5, 6, 7])
    assert (ttt.has_won() == (True, "ODD_WIN"))
    ttt.board = np.array([1, 3, 2,
                          Qttt.ttt.EMPTY_BLOCK_VAL, 4, 6,
